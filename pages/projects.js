...
/* harmony import */ var lib_getModels__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6155);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_getDatas__WEBPACK_IMPORTED_MODULE_2__, lib_getModels__WEBPACK_IMPORTED_MODULE_6__]);
([lib_getDatas__WEBPACK_IMPORTED_MODULE_2__, lib_getModels__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
async function getStaticProps(context) {
    let model = await (0,lib_getModels__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)("PROJECTS");
...
function Page({ data , model ,  }) {
    ...
    console.log(data);
    return data && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_mui_material_Box__WEBPACK_IMPORTED_MODULE_3___default()), {
        sx: {
            height: "100vh",
            width: "100%"
        },
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,141], () => (__webpack_exec__(2417)));
